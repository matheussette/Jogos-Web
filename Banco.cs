...
namespace Banco
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //se a decusção de iniciar com um depósito for sim
            if (decisao == "s")
            {
                ...
                Console.Write("\nDados da conta: Conta "
                    ...
                    + "\n Titular: " + nome
                    + "\n Saldo: " + valorIn);
                //entrando com valor pra depósito
            ...
            //se a decusção de iniciar com um depósito for não
            if (decisao == "n")
            {
                double T = 0;
                double total = T;
